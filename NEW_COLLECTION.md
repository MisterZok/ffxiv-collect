...
7. Copy an existing controller & views and modify as necessary for the new collection
    * Also do this for the API if desired
8. Copy an existing mod controller and modify as necessary for the new collection
9. Update the Import Progress logic for manual collections
10. Add the new collection to the `ownership.rake` model list
11. Update the API documentation in the repo wiki if new endpoints were added
